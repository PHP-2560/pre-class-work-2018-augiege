...
```{r}
# Within 3 decimal places, a probability increment of 1.3% seems to be the fairest for the player
expected_value <- mean(replicate(100, game_chain(n=100000, prob_inc=.013)))
expected_value

# This runs the game with a probability increment of 1.2%
# This is closer to 0 than 1.3% increment, however it is negative meaning
# the player is expected to lose money in the long run
